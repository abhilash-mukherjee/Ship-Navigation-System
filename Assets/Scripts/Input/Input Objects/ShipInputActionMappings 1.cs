...
//     version 1.4.3
//     from Assets/Scripts/Input/Input Objects/ShipInputActionMappings 1.inputactions
//
...
public partial class @ShipInputActionMappings1 : IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @ShipInputActionMappings1()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""ShipInputActionMappings 1"",
    ""maps"": [
        {
            ""name"": ""Ship"",
    ...
    {
        private @ShipInputActionMappings1 m_Wrapper;
        public ShipActions(@ShipInputActionMappings1 wrapper) { m_Wrapper = wrapper; }
